...
/**
 * @file plugins/importexport/abcd/filter/AbcdXmlMonographFilter.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2000-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class AbcdXmlMonographFilter
 * @ingroup plugins_importexport_abcd
 *
 * @brief Class that converts a Abcd XML document to a set of monographs.
 */

import('plugins.importexport.abcd.extras.abcd.filter.AbcdXmlSubmissionFilter');

class AbcdXmlMonographFilter extends AbcdXmlSubmissionFilter {
	/**
	 * Constructor
	...
	function getClassName() {
		return 'plugins.importexport.abcd.filter.AbcdXmlMonographFilter';
	}
