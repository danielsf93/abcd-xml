...
/**
 * @file plugins/importexport/abcd/filter/AbcdXmlPKPPublicationFilter.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2000-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class AbcdXmlPKPPublicationFilter
...
class AbcdXmlPKPPublicationFilter extends AbcdImportFilter {
	...
	function __construct($filterGroup) {
		$this->setDisplayName('Abcd XML publication import');
	...
	function parseAuthor($n, $publication) {
		...
		$importFilters = $filterDao->getObjectsByGroup('abcd-xml=>author');
