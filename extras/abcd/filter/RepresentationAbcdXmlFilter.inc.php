...
/**
 * @file plugins/importexport/abcd/filter/RepresentationAbcdXmlFilter.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2000-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class RepresentationAbcdXmlFilter
...
class RepresentationAbcdXmlFilter extends AbcdExportFilter {
	...
	function __construct($filterGroup) {
		$this->setDisplayName('Abcd XML representation export');
