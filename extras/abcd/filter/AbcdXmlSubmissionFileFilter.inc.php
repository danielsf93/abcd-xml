...
/**
 * @file plugins/importexport/abcd/filter/AbcdXmlSubmissionFileFilter.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2000-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class AbcdXmlSubmissionFileFilter
 * @ingroup plugins_importexport_abcd
 *
 * @brief Base class that converts a Abcd XML document to a submission file
 */
...
class AbcdXmlSubmissionFileFilter extends AbcdImportFilter {
	...
	function __construct($filterGroup) {
		$this->setDisplayName('Abcd XML submission file import');
