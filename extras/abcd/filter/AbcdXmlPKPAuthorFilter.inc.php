...
/**
 * @file plugins/importexport/abcd/filter/AbcdXmlPKPAuthorFilter.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2000-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class AbcdXmlPKPAuthorFilter
...
class AbcdXmlPKPAuthorFilter extends AbcdImportFilter {
	/**
	 * Constructor
	 * @param $filterGroup FilterGroup
	 */
	function __construct($filterGroup) {
		$this->setDisplayName('Abcd XML author import');
	...
	function getClassName() {
		return 'plugins.importexport.abcd.extras.abcd.filter.AbcdXmlPKPAuthorFilter';
	}
