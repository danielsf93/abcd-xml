<?php
/**
 * @defgroup plugins_importexport_abcd Abcd import/export plugin
 */

/**
 * @file plugins/importexport/abcd/PKPAbcdImportExportDeployment.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2000-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class PKPAbcdImportExportDeployment
 * @ingroup plugins_importexport_abcd
 *
 * @brief Base class configuring the abcd import/export process to an
 * application's specifics.
 */

import('lib.pkp.classes.plugins.importexport.PKPImportExportDeployment');

class PKPAbcdImportExportDeployment extends PKPImportExportDeployment {
	/**
	 * Constructor
